...
public class ApresentaAlteracaoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Livro l = RepositorioLivro.lerLivro(id);
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("Nome do Livro: <input type=\"text\" name=\"nomeLivro\" value='"+l.getNomeLivro()+"'><br>");
            out.println("Nome do Autor: <input type=\"text\" name=\"autor\" value='"+l.getAutor()+"'><br>");
            ...
            out.println("Ano de Publicação: <input type=\"text\" name=\"anoPublicacao\" value='"+l.getAnoPublicacao()+"'><br>");
            out.println("Assunto: <input type=\"text\" name=\"assunto\" value='"+l.getAssunto()+"'><br>");
