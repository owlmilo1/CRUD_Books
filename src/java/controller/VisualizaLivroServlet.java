...
public class VisualizaLivroServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Dados do Livro: " + l.getNomeLivro() + "</h1>");
            out.println("Autor: "+l.getAutor()+"<br>");
            out.println("Edição: "+l.getEdicao()+"<br>");
            out.println("Editora: "+l.getEditora()+"<br>");
            out.println("Ano de Publicação: "+l.getAnoPublicacao()+"<br>");
            out.println("Assunto: "+l.getAssunto()+"<br>");
