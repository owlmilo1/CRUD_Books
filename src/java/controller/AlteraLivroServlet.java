...
public class AlteraLivroServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Livro l = new Livro(anoPublicacao, nomeLivro, autor, edicao, editora, anoPublicacao, assunto);
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Livro Alterado com Sucesso!</h1>");
            out.println("<a href='ApresentaAlteracaoServlet'>Livros</a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
